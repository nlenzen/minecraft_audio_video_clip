...
from interface_util import load_clip_agent_env, get_prior_embed
...
def run_interactive(clip_path, clip_cfg, in_model, in_weights, cond_scale, seed, prior_info, output_video_dirpath):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--clip_path', type=str, default='checkpoints/model_mineclip/trained_no_act.pth')
    parser.add_argument('--clip_cfg', type=str, default='minecraft_audio_video_clip/configs/mineclip/10_layers_mineclip_no_activation.yaml')
    ...
    parser.add_argument('--prior_weights', type=str, default='STEVE-1/data/weights/steve1/steve1_prior.pt')
